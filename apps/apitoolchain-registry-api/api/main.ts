...
import { createRegistryApiRouter } from "./openapi/v1/src/generated/http/router";
import { apis } from "./v1";

const router = createRegistryApiRouter(apis);

// The raw spec-bytes route (`/apis/{id}/versions/{ref}/spec`) is now a typed op
// in the router (Apis.spec, a `*/*` body) — no longer hand-rolled here.
