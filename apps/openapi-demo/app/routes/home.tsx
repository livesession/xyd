...
import { Box, Button, Dropdown, Flex, TextField } from 'gestalt';
...
import { Surfaces, Framework, FwLink, useSettings, type FwSidebarGroupProps } from "@xyd-js/framework/react";
...
export default function Home() {
  ...
  return <>
    <Framework
      ...
      metadata={{}}
      surfaces={surfaces}
      BannerComponent={() => <ActionDropdownExample />}
    >
      <AtlasContext
        value={{
...
function $DemoTOC() {
  return <Toc defaultValue="quickstart">
    <Toc.Item id="quickstart">
      Quickstart
    </Toc.Item>
    <Toc.Item id="api-features">
      API Features
    </Toc.Item>
    <Toc.Item id="example-use-cases">
      Example Use Cases
    </Toc.Item>
  </Toc>
}
...
function SelectExample() {
  const examples = [
    {
      value: "https://raw.githubusercontent.com/openai/openai-openapi/refs/heads/master/openapi.yaml",
      label: "OpenAI",
    },
    {
      value: "https://api.monday.com/v2/get_schema?format=sdl",
      label: "Monday.com",
    },
  ]
...
function SelectTheme() {
  ...
  return <>
    <Button
      ...
      selected={open}
      size="sm"
      text={selected ? selected.label : 'Select theme'}
    />
    {
      open && (
        <Dropdown
