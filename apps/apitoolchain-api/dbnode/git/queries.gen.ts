...
import type {
  ...
  GetGitProviderArgs,
  GetGitProviderRow,
  InsertGitProviderArgs,
  InsertGitProviderRow,
  FindGitProviderByAccountArgs,
  FindGitProviderByAccountRow,
  UpdateGitProviderTokenArgs,
  UpdateGitProviderTokenRow,
  DeleteGitProviderArgs,
  ListRepoConnectionsRow,
  ListRepoConnectionsByTargetArgs,
  ListRepoConnectionsByTargetRow,
  GetRepoConnectionArgs,
  GetRepoConnectionRow,
  InsertRepoConnectionArgs,
  InsertRepoConnectionRow,
  DeleteRepoConnectionArgs,
  MarkRepoConnectionSyncingArgs,
  MarkRepoConnectionSyncedArgs,
  MarkRepoConnectionErrorArgs,
} from "./models.gen";
interface Client {
...
SELECT id, provider_id, target_kind, target_id, ref, repo, branch, prefix, last_synced_at, last_sync_status, last_sync_error, created_at, release_mode, auto_release, base_branch, prerelease, last_released_version, last_released_spec_version, webhook_id, webhook_secret, dist_tags FROM repo_connections ORDER BY created_at DESC`;
...
SELECT id, provider_id, target_kind, target_id, ref, repo, branch, prefix, last_synced_at, last_sync_status, last_sync_error, created_at, release_mode, auto_release, base_branch, prerelease, last_released_version, last_released_spec_version, webhook_id, webhook_secret, dist_tags FROM repo_connections
...
SELECT id, provider_id, target_kind, target_id, ref, repo, branch, prefix, last_synced_at, last_sync_status, last_sync_error, created_at, release_mode, auto_release, base_branch, prerelease, last_released_version, last_released_spec_version, webhook_id, webhook_secret, dist_tags FROM repo_connections WHERE id = $1`;
