...
export function McpServer() {
    return (
        <div className="relative min-h-full">
            ...
            <div className="max-w-5xl mx-auto space-y-8 blur-[2px] pointer-events-none select-none opacity-50">
                <div>
            ...
            <div className="absolute inset-0 z-10 flex items-center justify-center pointer-events-auto">
                <div className="bg-white/80 backdrop-blur-md px-10 py-12 rounded-3xl border border-gray-100 shadow-2xl text-center max-w-sm mx-auto transform translate-y-[-20px]">
                    ...
                    <p className="text-gray-500 text-sm mb-8 leading-relaxed">
                        Securely connect AI models to your documentation. This feature is currently in private beta and will be available soon.
                    </p>
