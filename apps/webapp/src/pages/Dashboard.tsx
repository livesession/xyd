import { Github, ExternalLink, GitCommitVertical, ChevronDown, Loader2 } from 'lucide-react';
    ...
    return (
        <div className="space-y-10">
            ...
            <div>
                ...
                <p className="text-gray-500 font-light">Overview of your documentation project.</p>
            </div>
            ...
            {currentRepository ? (
                <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-xl font-semibold text-gray-900">{currentRepository.name}</h2>
                                <p className="text-sm text-gray-500">{currentRepository.full_name}</p>
                            </div>
                        </div>
                    ...
                    <div className="bg-white border border-gray-100 rounded-xl p-6 space-y-4">
                        ...
                        {currentRepository.description && (
                            <div>
                                ...
                                <p className="text-sm text-gray-900">{currentRepository.description}</p>
                            </div>
                        )}
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="flex items-start gap-2 text-sm text-gray-600">
                                                    ...
                                                    <p className="break-words">{commit.commit.message.split('\n')[0]}</p>
                                                </div>
                ...
                <div className="text-center p-12 bg-white border border-gray-100 rounded-xl">
                    ...
                    <p className="text-gray-500 mb-4">Connect a GitHub repository to get started with documentation.</p>
                </div>
            )}
        </div>
    );
