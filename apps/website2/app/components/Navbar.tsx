        ...
        <div className="flex h-14 items-center justify-between">
          ...
          {/* <div className="flex items-center">
            <a href="/" className="flex items-center gap-2">
              <span className="text-xl font-bold text-white">x y d</span>
            </a>
          </div> */}

          {/* Navigation Links */}
          <div className="hidden md:flex items-center gap-8">
          <a href="/" className="flex items-center gap-2 transition-all duration-500">
          <svg
    ...
    <defs>
      <clipPath id="clip0_3_18">
        <rect width={64} height={18} fill="white" />
          ...
          {/* Mobile menu button */}
          <button className={`md:hidden transition-colors duration-500 ${isDarkSection ? 'text-white' : 'text-gray-900'}`}>
