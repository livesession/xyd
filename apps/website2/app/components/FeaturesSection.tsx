      ...
      <div className="relative mx-auto max-w-[1600px] px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-6xl lg:text-7xl font-normal mb-8" style={{ letterSpacing: '1px' }}>
            Docs in three, two, one...<br />
          </h2>
          <p className="text-gray-300 text-lg max-w-4xl mx-auto leading-relaxed">
            Built from ground up to build docs at scale. Zero config, zero hassle. Zero learning curve.
            Built-in themes, plugins, and components to get you started.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-32">
          <div>
            <h3 className="text-4xl lg:text-5xl font-normal mb-6 leading-tight">
              You can ship docs in minutes, not days. Do what's the most matter — content.
            </h3>
          </div>
          <div>
            <p className="text-gray-300 text-lg mb-8 leading-relaxed">
              Built with love and care to make documentation easier and more accessible for everyone. Open source, open mind.
            </p>
            <a 
        ...
        {/* Video Section */}
        <div className="relative rounded-2xl overflow-hidden shadow-2xl p-4 max-w-7xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-blue-600/20 via-purple-600/20 to-pink-600/20 h-[85vh]">
            ...
            <video 
              ...
              playsInline
            >
              <source src="./xydemo1web.mp4" type="video/mp4" />
