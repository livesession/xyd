...
export default function Home() {
    ...
    return (
        <>
            <header>
                {icon(28)}
                <span className="name">React Router × Vite 7</span>
                <nav><a href="/docs">Docs</a></nav>
            </header>
            <main>
                <div>
                    {icon(72)}
                    <h1 id="host-marker" data-hydrated={hydrated ? "true" : undefined} style={{ marginTop: 24 }}>
                        Host RR App
                    </h1>
                    <p className="tag">A React Router × Vite 7 site with xyd docs mounted at /docs — one build, one origin.</p>
                </div>
            </main>
        </>
    );
