...
function Icon(props) {
    return (
        <svg viewBox="0 0 24 24" aria-hidden="true" style={{ width: `${props.size}px`, height: `${props.size}px`, fill: "var(--brand)" }}>
            <path d={BRAND_PATH} />
        </svg>
    );
}
    ...
    return (
        <>
            ...
            <main>
                <div>
                    <Icon size={72} />
                    <h1 id="host-marker" style={{ "margin-top": "24px" }}>Host Solid App</h1>
                    <p class="tag">A Solid site with xyd docs mounted at /docs — one build, one origin.</p>
                </div>
            </main>
        </>
    );
