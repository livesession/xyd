  ...
  namespace React {
    namespace JSX {
        interface IntrinsicElements {
            ...
            // Components
            'xyd-blockquote': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
            ...
            'xyd-code': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
            'xyd-breadcrumbs': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
            'xyd-details': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
            ...
            'xyd-heading': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
            'xyd-hr': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
            'xyd-list': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
            'xyd-list-item': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
            'xyd-navlinks': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
            'xyd-pre': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
            ...
            'xyd-table': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
            ...
            'xyd-text': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
