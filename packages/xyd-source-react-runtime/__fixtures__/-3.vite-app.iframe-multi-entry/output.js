...
ThemeContext.__xydUniform = JSON.parse('{"title":"ThemeContext","canonical":"","description":"","definitions":[{"title":"Props","properties":[{"name":"mode","type":"$$xor","description":"","meta":[{"name":"required","value":"true"}],"properties":[{"name":"dark","type":"string","description":""},{"name":"light","type":"string","description":""}]},{"name":"setMode","type":"$$function","description":"","meta":[{"name":"required","value":"true"}],"properties":[{"name":"mode","type":"$$xor","description":"","properties":[{"name":"dark","type":"string","description":""},{"name":"light","type":"string","description":""}],"meta":[]}],"ofProperty":{"name":"","type":"unknown","description":"","meta":[]}}],"meta":[{"name":"type","value":"parameters"}]}],"examples":{"groups":[]}}');
UserCard.__xydUniform = JSON.parse('{"title":"UserCard","canonical":"","description":"","definitions":[{"title":"Props","properties":[{"name":"user","type":"object","description":"","meta":[{"name":"required","value":"true"}],"properties":[{"name":"name","type":"string","description":"","meta":[{"name":"required","value":"true"}]},{"name":"email","type":"string","description":"","meta":[{"name":"required","value":"true"}]},{"name":"id","type":"number","description":"","meta":[{"name":"required","value":"true"}]},{"name":"joinedAt","type":"Date","description":"","meta":[{"name":"required","value":"true"}]}]},{"name":"role","type":"$$xor","description":"","meta":[{"name":"required","value":"true"}],"properties":[{"name":"admin","type":"string","description":""},{"name":"editor","type":"string","description":""},{"name":"viewer","type":"string","description":""}]},{"name":"permissions","type":"$array","description":"","meta":[{"name":"required","value":"true"}],"properties":[],"ofProperty":{"name":"","type":"string","properties":[],"description":"","meta":[{"name":"required","value":"true"}]}},{"name":"onEdit","type":"$$function","description":"","meta":[{"name":"required","value":"true"}],"properties":[{"name":"id","type":"number","description":"","properties":[],"meta":[]}],"ofProperty":{"name":"","type":"unknown","description":"","meta":[]}},{"name":"tags","type":"Map<string, boolean>","description":"","meta":[{"name":"required","value":"true"}]},{"name":"statusIndicator","type":"object","description":"","meta":[{"name":"required","value":"true"}],"properties":[{"name":"type","type":"string","description":"","meta":[{"name":"required","value":"true"}]},{"name":"props","type":"any","description":"","meta":[{"name":"required","value":"true"}]},{"name":"key","type":"string","description":"","meta":[{"name":"required","value":"true"}]}]},{"name":"actionBar","type":"object","description":"","meta":[],"properties":[{"name":"type","type":"string","description":"","meta":[{"name":"required","value":"true"}]},{"name":"props","type":"any","description":"","meta":[{"name":"required","value":"true"}]},{"name":"key","type":"string","description":"","meta":[{"name":"required","value":"true"}]}]}],"meta":[{"name":"type","value":"parameters"}]},{"title":"State","properties":[{"name":"expanded","type":"unknown","description":"","meta":[{"name":"hookID","value":"0"},{"name":"setter","value":"setExpanded"}]}],"meta":[{"name":"type","value":"state"}]}],"examples":{"groups":[]}}');
TodoItem.__xydUniform = JSON.parse('{"title":"TodoItem","canonical":"","description":"","definitions":[{"title":"Props","properties":[{"name":"id","type":"number","description":"","meta":[{"name":"required","value":"true"}]},{"name":"title","type":"string","description":"","meta":[{"name":"required","value":"true"}]},{"name":"completed","type":"boolean","description":"","meta":[{"name":"required","value":"true"}]},{"name":"priority","type":"$$xor","description":"","meta":[{"name":"required","value":"true"}],"properties":[{"name":"medium","type":"string","description":""},{"name":"low","type":"string","description":""},{"name":"high","type":"string","description":""}]},{"name":"onToggle","type":"$$function","description":"","meta":[{"name":"required","value":"true"}],"properties":[{"name":"id","type":"number","description":"","properties":[],"meta":[]}],"ofProperty":{"name":"","type":"unknown","description":"","meta":[]}}],"meta":[{"name":"type","value":"parameters"}]}],"examples":{"groups":[]}}');
ThemeProvider.__xydUniform = JSON.parse('{"title":"ThemeProvider","canonical":"","description":"","definitions":[{"title":"Props","properties":[{"name":"children","type":"ReactNode","description":"","meta":[{"name":"required","value":"true"}]}],"meta":[{"name":"type","value":"parameters"}]},{"title":"State","properties":[{"name":"mode","type":"unknown","description":"","meta":[{"name":"hookID","value":"0"},{"name":"setter","value":"setMode"}]}],"meta":[{"name":"type","value":"state"}]}],"examples":{"groups":[]}}');
export {
  SampleApp,
  ThemeContext,
  ThemeProvider,
