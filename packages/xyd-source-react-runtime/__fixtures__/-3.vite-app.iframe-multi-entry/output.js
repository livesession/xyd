...
ThemeProvider.__xydUniform = JSON.parse('{"title":"ThemeProvider","canonical":"","description":"","definitions":[{"title":"Props","properties":[{"name":"children","type":"ReactNode","description":"","meta":[{"name":"required","value":"true"}]}],"meta":[{"name":"type","value":"parameters"}]}],"examples":{"groups":[]}}');
export {
  SampleApp,
  ThemeContext,
  ThemeProvider,
