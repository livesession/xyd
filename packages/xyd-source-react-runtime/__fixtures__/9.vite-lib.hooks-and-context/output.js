...
ThemeContext.__xydUniform = JSON.parse('{"title":"ThemeContext","canonical":"","description":"","definitions":[{"title":"Props","properties":[{"name":"mode","type":"$xor","description":"","meta":[{"name":"required","value":"true"}],"properties":[{"name":"","type":"object","description":"","meta":[{"name":"required","value":"true"}]},{"name":"","type":"object","description":"","meta":[{"name":"required","value":"true"}]}]},{"name":"primaryColor","type":"string","description":"","meta":[{"name":"required","value":"true"}]},{"name":"fontSize","type":"number","description":"","meta":[{"name":"required","value":"true"}]},{"name":"setMode","type":"(mode: $xor) => unknown","description":"","meta":[{"name":"required","value":"true"}]},{"name":"setPrimaryColor","type":"(color: string) => unknown","description":"","meta":[{"name":"required","value":"true"}]},{"name":"setFontSize","type":"(size: number) => unknown","description":"","meta":[{"name":"required","value":"true"}]}],"meta":[{"name":"type","value":"parameters"}]}],"examples":{"groups":[]}}');
