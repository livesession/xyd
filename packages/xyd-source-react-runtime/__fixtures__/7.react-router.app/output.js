...
ProductCard.__xydUniform = JSON.parse('{"title":"ProductCard","canonical":"","description":"","definitions":[{"title":"Props","properties":[{"name":"product","type":"Product","description":"","meta":[{"name":"required","value":"true"}],"properties":[{"name":"id","type":"string","description":"","meta":[{"name":"required","value":"true"}]},{"name":"name","type":"string","description":"","meta":[{"name":"required","value":"true"}]},{"name":"price","type":"number","description":"","meta":[{"name":"required","value":"true"}]},{"name":"category","type":"string","description":"","meta":[{"name":"required","value":"true"}]},{"name":"inStock","type":"boolean","description":"","meta":[{"name":"required","value":"true"}]}]},{"name":"onAddToCart","type":"$$function","description":"","meta":[{"name":"required","value":"true"}],"properties":[{"name":"productId","type":"string","description":"","properties":[],"meta":[]}],"ofProperty":{"name":"","type":"unknown","description":"","meta":[]}},{"name":"layout","type":"$$xor","description":"","meta":[],"properties":[{"name":"list","type":"string","description":""},{"name":"grid","type":"string","description":""}]}],"meta":[{"name":"type","value":"parameters"}]}],"examples":{"groups":[]}}');
const PRODUCTS = [{
  id: "1",
  name: "Keyboard",
  price: 79,
