...
TodoItem.__xydUniform = JSON.parse('{"title":"TodoItem","canonical":"","description":"","definitions":[{"title":"Props","properties":[{"name":"todo","type":"object","description":"The todo data to render","meta":[{"name":"required","value":"true"}],"properties":[{"name":"id","type":"string","description":"","meta":[{"name":"required","value":"true"}]},{"name":"title","type":"string","description":"","meta":[{"name":"required","value":"true"}]},{"name":"description","type":"string","description":"","meta":[]},{"name":"completed","type":"boolean","description":"","meta":[{"name":"required","value":"true"}]},{"name":"priority","type":"$xor","description":"","meta":[{"name":"required","value":"true"}],"properties":[{"name":"low","type":"string","description":""},{"name":"medium","type":"string","description":""},{"name":"high","type":"string","description":""},{"name":"urgent","type":"string","description":""}]},{"name":"tags","type":"$array","description":"","meta":[{"name":"required","value":"true"}],"properties":[],"ofProperty":{"name":"","type":"string","properties":[],"description":"","meta":[{"name":"required","value":"true"}]}},{"name":"createdAt","type":"string","description":"","meta":[{"name":"required","value":"true"}]},{"name":"completedAt","type":"string","description":"","meta":[]},{"name":"dueDate","type":"string","description":"","meta":[]}]},{"name":"onToggle","type":"(id: string) => unknown","description":"Called when the checkbox is toggled","meta":[{"name":"required","value":"true"}]},{"name":"onDelete","type":"(id: string) => unknown","description":"Called when the delete button is clicked","meta":[{"name":"required","value":"true"}]},{"name":"onUpdate","type":"(id: string, updates: object) => unknown","description":"Called when the todo is updated","meta":[{"name":"required","value":"true"}]},{"name":"autoEdit","type":"boolean","description":"Enable inline editing mode on mount","meta":[]}],"meta":[{"name":"type","value":"parameters"}]},{"title":"State","properties":[{"name":"editing","type":"unknown","description":"","meta":[{"name":"hookID","value":"0"},{"name":"setter","value":"setEditing"}]},{"name":"editTitle","type":"unknown","description":"","meta":[{"name":"hookID","value":"1"},{"name":"setter","value":"setEditTitle"}]}],"meta":[{"name":"type","value":"state"}]}],"examples":{"groups":[]}}');
...
AddTodoForm.__xydUniform = JSON.parse('{"title":"AddTodoForm","canonical":"","description":"","definitions":[{"title":"Props","properties":[{"name":"onAdd","type":"(title: string, priority: $xor, description: string, tags: $array) => unknown","description":"Callback fired after a todo is successfully added","meta":[{"name":"required","value":"true"}]},{"name":"defaultPriority","type":"$xor","description":"Default priority for new todos","meta":[],"properties":[{"name":"low","type":"string","description":""},{"name":"medium","type":"string","description":""},{"name":"high","type":"string","description":""},{"name":"urgent","type":"string","description":""}]},{"name":"placeholder","type":"string","description":"Placeholder text for the title input","meta":[]}],"meta":[{"name":"type","value":"parameters"}]},{"title":"State","properties":[{"name":"title","type":"unknown","description":"","meta":[{"name":"hookID","value":"0"},{"name":"setter","value":"setTitle"}]},{"name":"priority","type":"unknown","description":"","meta":[{"name":"hookID","value":"1"},{"name":"setter","value":"setPriority"}]},{"name":"description","type":"unknown","description":"","meta":[{"name":"hookID","value":"2"},{"name":"setter","value":"setDescription"}]},{"name":"tags","type":"unknown","description":"","meta":[{"name":"hookID","value":"3"},{"name":"setter","value":"setTags"}]}],"meta":[{"name":"type","value":"state"}]}],"examples":{"groups":[]}}');
