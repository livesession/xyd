...
export const DEFAULT_BASE_URL = "https://api.uniondepot.test/v1";
const USER_AGENT = "x-union-depot-node/0.4.0";
const AI_AGENT_ENV_VARS: Record<string, string> = { "CLAUDE_CODE": "claude-code", "CURSOR_AGENT": "cursor", "CLINE_ACTIVE": "cline", "WINDSURF_ACTIVE": "windsurf", "COPILOT_AGENT": "copilot", "MY_AGENT": "mine" };
const DEFAULT_TIMEOUT_MS = 1234;
const TIMEOUT_ENV_VAR = "WIRE_TIMEOUT_MS";
const MAX_RETRIES = 5;
const RETRYABLE_STATUS_CODES = new Set<number>([429]);
const RETRY_CONNECTION_ERRORS = false;
const HONOR_RETRY_AFTER_HEADER = false;
const BACKOFF_INITIAL_DELAY_MS = 100;
const BACKOFF_MAX_DELAY_MS = 2000;
const BACKOFF_MULTIPLIER = 3;
const BACKOFF_JITTER = 0;
const IDEMPOTENCY_HEADER = "X-Idem";
