        ...
        <div style={{
            ...
            <div style={{
                ...
                <GuideCard
                    ...
                    kind="secondary"
                >
                    Capture user interactions like clicks, page views, and events directly from your app with minimal impact on performance.
                </GuideCard>
                ...
                <GuideCard
                    ...
                    kind="secondary"
                >
                    Access and manage session data, events, and user journeys programmatically. Perfect for custom dashboards and third-party integrations.
                </GuideCard>
                ...
                <GuideCard
                    ...
                    kind="secondary"
                >
                    Query session data, user interactions, and event tracking with precision. Build custom integrations to enhance your product analytics.
                </GuideCard>
