...
USER_AGENT = "x-union_depot-python/0.4.0"
AI_AGENT_ENV_VARS = {"CLAUDE_CODE": "claude-code", "CURSOR_AGENT": "cursor", "CLINE_ACTIVE": "cline", "WINDSURF_ACTIVE": "windsurf", "COPILOT_AGENT": "copilot", "MY_AGENT": "mine"}
DEFAULT_TIMEOUT: Optional[float] = 1.234
TIMEOUT_ENV_VAR = "WIRE_TIMEOUT_MS"
MAX_RETRIES = 5
...
ERROR_DOC_URL_TEMPLATE = "https://errs.test/{kind}"
GUARDED_OPTION_KEYS = frozenset({"api_key"})
...
def _error_for_status(status_code: int, headers: dict[str, str], body: bytes) -> APIError:
    ...
    if cls is None:
        cls = ServerError if status_code >= 500 else ClientError
