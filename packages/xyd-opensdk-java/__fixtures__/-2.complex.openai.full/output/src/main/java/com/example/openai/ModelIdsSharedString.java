...
public enum ModelIdsSharedString implements Json.JsonEnum {
  GPT_5_4("gpt-5.4"),
  ...
  ModelIdsSharedString(String value) {
    this.value = value;
  }
  ...
  public static ModelIdsSharedString fromValue(String value) {
    for (ModelIdsSharedString item : values()) {
      if (item.value.equals(value)) {
        return item;
      }
    }
    throw new IllegalArgumentException("unknown ModelIdsSharedString value: " + value);
  }

  public static ModelIdsSharedString fromJson(Object json) {
