 ...
 */
export function generateNodeServer(
...
/**
 * Auto-generated by xyd build with edge.platform: "node"
...
const server = createServer((req, res) => {
  ...
  if (!result.ok) {
    const redir = LOGIN_URL + (LOGIN_URL.includes("?") ? "&" : "?") + "redirect=" + encodeURIComponent(path);
