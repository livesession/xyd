...
module WireKitchen
  ...
  USER_AGENT = "x-wire_kitchen-ruby/0.3.0"
    ...
    def request(method:, path:, query: nil, body: nil, headers: nil, encoding: "json", raw: false, idempotency: false)
      ...
      unless body.nil?
        ...
        body.each do |key, value|
          payload[key] = WireKitchen.encode(value) unless value.nil?
        end
        if encoding == "multipart"
          data, content_type = WireKitchen.multipart_body(payload)
      ...
      unless query.nil?
        ...
        query.each do |key, value|
          next if value.nil?
          encoded = WireKitchen.encode(value)
    ...
    def perform(method, url, headers, data, raw)
      ...
      loop do
        ...
        if status >= 400
          ...
          raise WireKitchen.error_for_status(status, response_headers, response.body)
        end
