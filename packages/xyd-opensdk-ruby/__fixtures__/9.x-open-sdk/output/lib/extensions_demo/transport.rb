...
module ExtensionsDemo
  DEFAULT_BASE_URL = "https://api.demo.io/v1"
  USER_AGENT = "extensions_demo-ruby/1.0.0"
    ...
    def request(method:, path:, query: nil, body: nil, headers: nil, encoding: "json", raw: false, idempotency: false)
      ...
      unless body.nil?
        ...
        body.each do |key, value|
          payload[key] = ExtensionsDemo.encode(value) unless value.nil?
        end
        if encoding == "multipart"
          data, content_type = ExtensionsDemo.multipart_body(payload)
      ...
      unless query.nil?
        ...
        query.each do |key, value|
          next if value.nil?
          encoded = ExtensionsDemo.encode(value)
    ...
    def perform(method, url, headers, data, raw)
      ...
      loop do
        ...
        if status >= 400
          ...
          raise ExtensionsDemo.error_for_status(status, response_headers, response.body)
        end
