			...
			&cli.Command{
				...
				Commands: []*cli.Command{
					&cli.Command{
						...
						Action: handleOrganizationUsersList,
					},
				},
			},
		},
...
func handleOrganizationUsersList(ctx context.Context, cmd *cli.Command) error {
	...
	if cmd.IsSet("emails") {
		query.Set("emails", fmt.Sprint(cmd.StringSlice("emails")))
	}
	req := runtime.Request{
		Method: "GET",
		Path: path,
