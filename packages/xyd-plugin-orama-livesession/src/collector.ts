import type { SearchEvent, AnalyticsConfig } from './types'
import { sendBeacon } from './pollyfills'
import { ANALYTICS_OSS_SOURCE } from './const'
...
export class Collector {
  ...
  public flush(): void {
    ...
    sendBeacon(this.config.endpoint + `?api-key=${this.config.apiKey}`, body)
  }
