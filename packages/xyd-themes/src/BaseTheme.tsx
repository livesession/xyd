...
export abstract class BaseTheme extends BaseThemeSettings {
    ...
    protected TocBottom() {
        return <>
            ...
            <div className="TocBottomHost">
                <div className="TocBottomContainer">
                    <a
                        href="https://github.com/xyd-js/xyd-samples/tree/main/example"
                        target="_blank"
                        rel="noreferrer"
                        className="TocBottomLink"
                    >
                        <div className="TocBottomLinkTitleContainer">
                            <div className="TocBottomLinkTitle">Sample app</div>
                            <svg
                        ...
                        <div className="TocBottomDescription">Set up <code>xyd</code> with multiple environments.</div>
                    </a>
                </div>
            </div>
        </>
