...
import styles from './Terminal2.module.css';
...
const steps: Step[] = [
    ...
    {text: 'open ./docs/introduction.mdx', status: 'pending', isCommand: true, pauseForView: true},
...
function $Tabs() {
    return <div className={styles.EditorHeading}>
        ...
        <$Tab tab="introduction" Icon={FileIcon}>introduction.mdx</$Tab>
    </div>
}
