...
export function Safari({
  ...
  return (
    <div className={styles.safariWrapper}>
      <svg
        width="100%"
        height="100%"
      ...
      >
        <g clipPath="url(#path0)">
          <path
            ...
            className={`${styles.safariContainer} dark:${styles.darkSafariContainer}`}
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
          ...
          <path
            ...
            className={`${styles.safariContent} dark:${styles.darkSafariContent}`}
          />
          <circle cx="27" cy="25" r="6" className={`${styles.safariContainer} dark:${styles.darkSafariContainer}`} />
          <circle cx="47" cy="25" r="6" className={`${styles.safariContainer} dark:${styles.darkSafariContainer}`} />
          <circle cx="67" cy="25" r="6" className={`${styles.safariContainer} dark:${styles.darkSafariContainer}`} />
          <path
            d="M286 17C286 13.6863 288.686 11 292 11H946C949.314 11 952 13.6863 952 17V35C952 38.3137 949.314 41 946 41H292C288.686 41 286 38.3137 286 35V17Z"
            className={`${styles.safariContainer} dark:${styles.darkSafariContainer}`}
          />
          <g className={styles.luminosityBlend}>
            <path
