...
- **Unit**: `apitoolchain/packages/xyd-mcp-uniform/__tests__/` — data-driven fixtures with a stubbed fetcher. Covers basic, nested-schema, multiple-tools, resources, and auth-bearer cases.
