...
public class ApiException extends RuntimeException {
  ...
  public static ApiException of(int statusCode, String message, byte[] rawBody, String requestId) {
    switch (statusCode) {
      ...
      case 404:
        return new MissingException(statusCode, message, rawBody, requestId);
      case 409:
    ...
    if (statusCode >= 500) {
      return new ServerException(statusCode, message, rawBody, requestId);
    }
    return new ClientException(statusCode, message, rawBody, requestId);
  }
}
