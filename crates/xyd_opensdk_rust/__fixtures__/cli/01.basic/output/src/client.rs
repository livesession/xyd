...
impl Client {
    ...
    pub fn projects(&self) -> crate::projects::Projects {
        crate::projects::Projects::new(self.runner.clone())
    }
    ...
    ///
    /// Runs `acme status`.
    pub async fn status(&self, params: ClientStatusParams) -> Result<CommandResult, Error> {
        let mut argv: Vec<String> = vec!["status".to_string()];
