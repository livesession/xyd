...
pub const DEFAULT_BASE_URL: &str = "https://api.uniondepot.test/v1";
pub const USER_AGENT: &str = "x-union_depot-rust/0.4.0";
pub const DEFAULT_TIMEOUT_MS: u64 = 1234;
pub const MAX_RETRIES: u32 = 5;
pub const RETRYABLE_STATUS: &[u16] = &[429];
pub const RETRY_CONNECTION_ERRORS: bool = false;
pub const HONOR_RETRY_AFTER: bool = false;
pub const BACKOFF_INITIAL_MS: u64 = 100;
pub const BACKOFF_MAX_MS: u64 = 2000;
pub const BACKOFF_MULTIPLIER: f64 = 3.0;
pub const BACKOFF_JITTER: f64 = 0.0;
pub const REQUEST_ID_HEADER: &str = "X-Req";
pub const IDEMPOTENCY_HEADER: &str = "X-Idem";
const AI_AGENT_ENV_VARS: &[(&str, &str)] = &[("CLAUDE_CODE", "claude-code"), ("CURSOR_AGENT", "cursor"), ("CLINE_ACTIVE", "cline"), ("WINDSURF_ACTIVE", "windsurf"), ("COPILOT_AGENT", "copilot"), ("MY_AGENT", "mine")];
