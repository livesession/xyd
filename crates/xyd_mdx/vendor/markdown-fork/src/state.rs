...
pub fn call(tokenizer: &mut Tokenizer, name: Name) -> State {
    let func = match name {
        ...
        Name::DirectiveLeafNameInside => construct::directive_leaf::name_inside,
        Name::DirectiveLeafAfterName => construct::directive_leaf::after_name,
        Name::DirectiveLeafAttributesStart => construct::directive_leaf::attributes_start,
        Name::DirectiveLeafAttributesInside => construct::directive_leaf::attributes_inside,
        ...
        Name::DirectiveContainerNameInside => construct::directive_container::name_inside,
        ...
        Name::DirectiveContainerAfterOpen => construct::directive_container::after_open,
        Name::DirectiveContainerAtNonLazyBreak => construct::directive_container::at_non_lazy_break,
        ...
        Name::DirectiveContainerContentBefore => construct::directive_container::content_before,
