...
// xyd C-S2: vendored fork of mdxjs-rs 1.0.4 (adds 2 exhaustiveness arms for the
// forked-markdown directive mdast nodes). Vendored third-party code is not held
// to this repo's `-D warnings` gate; see the sibling markdown-fork note.
#![allow(warnings)]
#![allow(clippy::all)]
