...
// the retryable status set) are retried. Default: 5 (sdk.retry). Zero
// disables retries.
...
// gets a fresh timeout). Default: 1234ms, overridable via the WIRE_TIMEOUT_MS env var (sdk.timeout). Zero disables the
// deadline.
...
// lifecycle events (request.start).
