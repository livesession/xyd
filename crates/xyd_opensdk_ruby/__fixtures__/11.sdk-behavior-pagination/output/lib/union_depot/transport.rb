...
module UnionDepot
  ...
  USER_AGENT = "x-union_depot-ruby/0.4.0"
  AI_AGENT_ENV_VARS = { "CLAUDE_CODE" => "claude-code", "CURSOR_AGENT" => "cursor", "CLINE_ACTIVE" => "cline", "WINDSURF_ACTIVE" => "windsurf", "COPILOT_AGENT" => "copilot", "MY_AGENT" => "mine" }.freeze
  MAX_RETRIES = 5
  RETRYABLE_STATUS_CODES = [429].freeze
  RETRY_CONNECTION_ERRORS = false
  HONOR_RETRY_AFTER_HEADER = false
  BACKOFF_INITIAL_DELAY = 0.1
  BACKOFF_MAX_DELAY = 2.0
  BACKOFF_MULTIPLIER = 3.0
  BACKOFF_JITTER = 0.0
  REQUEST_ID_HEADER = "X-Req"
  ...
  def self.error_for_status(status_code, headers, body)
    ...
    klass = (status_code >= 500 ? ServerError : ClientError) if klass.nil?
  ...
  class Transport
    ...
    def initialize(api_key: nil, base_url: nil, timeout: nil)
      ...
      @timeout = timeout.nil? ? 1.234 : timeout
